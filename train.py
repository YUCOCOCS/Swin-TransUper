...
parser.add_argument('--root_path', type=str,
                    default='/home/JianjianYin/Swin-TransUper/ISIC2017', help='root dir for data')
parser.add_argument('--config_file', type=str,
                    default='swin_224_7_3level', help='config file name w/o suffix')
parser.add_argument('--dataset', type=str,
                    default='isic2017', help='Synapse/isic2017/isic2018')
parser.add_argument('--list_dir', type=str,
                    default='/home/JianjianYin/Swin-TransUper/lists/lists_Synapse', help='list dir')
parser.add_argument('--num_classes', type=int,
                    default=9, help='output channel of network')
parser.add_argument('--output_dir', type=str, default='/home/JianjianYin/Swin-TransUper/isic2017', help='output dir')                   
